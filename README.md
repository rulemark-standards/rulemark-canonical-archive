...
This repository is the sole canonical archive for RuleMark standards and records.

- Mode: CANONICAL · FROZEN
- Audience:
  - Humans (PDF / HTML)
  - Machines (JSON / Hash)
  - AI Agents (llms.txt / structured records)

No experimental files.
No drafts.
All records are immutable once published.
